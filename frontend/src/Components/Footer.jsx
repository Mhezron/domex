...
<footer className="bg-white">
  <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8">
    ...
    <img src="/path/to/domex-logo.svg" alt="DOMEX " className="h-8" />
</div>
        ...
        <div className="mx-auto mt-8 max-w-md sm:ms-0">
          ...
          <form className="mt-4">
            <div className="flex flex-col gap-4 sm:flex-row lg:flex-col lg:items-start">
              ...
              <button
                className="block w-full rounded bg-blue-500 px-12 py-3 text-sm font-medium text-white shadow hover:bg-blue-600 focus:outline-none focus:ring active:bg-blue-500 sm:w-auto"
              >
                Subscribe
              </button>
            </div>
      ...
      <ul className="mt-4 flex justify-center gap-6 sm:mt-0 sm:justify-start">
        <li>
          <a
            ...
            rel="noreferrer"
            target="_blank"
            className="text-blue-500 transition hover:text-blue-600/75"
          >
